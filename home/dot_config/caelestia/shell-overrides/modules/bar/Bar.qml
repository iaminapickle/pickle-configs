...
ColumnLayout {
    ...
    function isCurrent(name: string): bool {
        return popouts.hasCurrent && popouts.currentName === name;
    }
    ...
    function checkPopout(y: real): void {
        ...
        if (id === "statusIcons" && Config.bar.popouts.statusIcons) {
            ...
            // Tray icons open their own popout (see TrayItem), so only the compact
            // expand/collapse toggle is left to handle here
