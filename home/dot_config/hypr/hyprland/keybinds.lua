...
-- Go to workspace -1/+1, wrapping within the focused monitor's own block of 10
create_bind(vars.kbPrevWs, fn.wsrelative("focus", -1), repeating_unless_mouse)
create_bind(vars.kbNextWs, fn.wsrelative("focus", 1), repeating_unless_mouse)
...
-- Move window to workspace -1/+1, wrapping within the focused monitor's own block of 10
create_bind(vars.kbMoveWinToWsNext, fn.wsrelative("move", 1), repeating_unless_mouse)
create_bind(vars.kbMoveWinToWsPrev, fn.wsrelative("move", -1), repeating_unless_mouse)
