...
return {
    ...
    -- Per-monitor workspace blocks: SUPER+<n> resolves to (base + n) on the
    -- focused monitor. Keep in sync with the workspace_rule loop in
    -- hyprland/monitors.lua, which pins workspaces base+1..base+10 to each.
